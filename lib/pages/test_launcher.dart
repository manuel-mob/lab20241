...
class TestLauncher extends StatefulWidget {
  const TestLauncher({super.key, required this.title});
  final String title;

  @override
  State<TestLauncher> createState() => _TestLauncherState();
}

class _TestLauncherState extends State<TestLauncher> {
  ...
  Future<void> _launchMail(Uri mailto) async {
    if (!await launchUrl(
      mailto,
  ...
  Widget build(BuildContext context) {
    ...
    final Uri mailTo = 
        Uri(scheme: 'mailto', path: 'manuel@mobiquos.cl', query: 'subject=App Feedback&body=App Version 3.23');  
    return Scaffold(
      appBar: AppBar(
